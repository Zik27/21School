...
/*   Updated: 2019/12/29 13:36:25 by vurrigon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void				(*t_func_pointer)(t_tokens *token, char *name,
										unsigned short instr, t_player *pl);
...
int							handling_label(t_player *player, char *line,
													int len);
...
void						check_reg(t_tokens *token, char *name,
										unsigned short instr, t_player *pl);
void						check_dir(t_tokens *token, char *name,
										unsigned short instr, t_player *pl);
void						check_dir_label(t_tokens *token, char *name,
											unsigned short instr, t_player *pl);
void						check_indir(t_tokens *token, char *name,
										unsigned short instr, t_player *pl);
void						check_indir_label(t_tokens *token, char *name,
											unsigned short instr, t_player *pl);
void						check_type_arg(t_type	type, int need_type,
											t_instr *instr, int num);
...
void						continue_name_com(int flag, t_player *player,
													char *line, char **tmp);
char						*finish_add_nam_com(int flag, t_player *player,
...
void						change_col_num(t_player *player, char **arg_line,
								char *arg);
...
void						int32_to_bytecode(unsigned char *bytes, int value,
																	int size);
